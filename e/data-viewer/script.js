...
const BRAND_LIST = [
    '007', '20th Century Studios', '2K', 'A24', 'ABC News', 'Acer', 'Activision', 'Acura',
    'Adidas', 'Air Jordan', 'Airbus', 'Alibaba', 'AliExpress', 'AMD', 'American Express',
    'American Red Cross', 'Amex', 'Android', 'Animal Crossing', 'Apex Legends', 'Apple TV+',
    'Aprilia', 'Aragorn', 'Arc\'teryx', 'Asics', 'ASOS', 'Assassin\'s Creed', 'Aston Martin', 'ASUS',
    'AT&T', 'Atari', 'Attack on Titan', 'Audemars Piguet', 'Audi', 'Avatar The Last Airbender',
    'Avengers', 'Baby Yoda', 'Bacardi', 'Back to the Future', 'Balenciaga', 'Bandai Namco', 'BAPE',
    'Barbie', 'Baskin-Robbins', 'Batman', 'BBC', 'Ben & Jerry\'s', 'Bentley', 'Best Buy', 'Bethesda',
    'Binance', 'Birkenstock', 'Bitcoin', 'Black Ops', 'Bloodborne', 'Bloomberg', 'BMW',
    'Boeing', 'Bombardier', 'Bose', 'BTC', 'Bud Light', 'Budweiser', 'Bugatti', 'Buick', 'Bulgari', 'Bundesliga',
    'Burberry', 'Burger King', 'ByteDance', 'Cadillac', 'Call of Duty', 'Calvin Klein', 'Capcom',
    'Captain Kirk', 'Care Bears', 'Cartier', 'Cartoon Network', 'Cash App', 'CBS', 'CDC',
    'Celine', 'Chanel', 'Charizard', 'Chevrolet', 'Chevy', 'Chick-fil-A', 'Chipotle', 'Chrysler', 'CIA',
    'CNN', 'Coca-Cola', 'Coinbase', 'Coke', 'Columbia Pictures', 'Coors', 'Corsair',
    'Costco', 'Counter-Strike', 'Crayola', 'Crocs', 'Crunchyroll', 'CS2', 'CS:GO', 'Cyberpunk 2077', 'Dark Souls',
    'Darth Vader', 'DC Comics', 'Death Note', 'Dell', 'Demogorgon', 'Demon Slayer', 'Despicable Me', 'Diablo',
    'Dior', 'Disney', 'Disney+', 'DJI', 'Dogecoin', 'Dolce & Gabbana',
    'Domino\'s', 'Donkey Kong', 'Dota 2', 'Dr Pepper', 'Dr. Martens', 'Dragon Ball', 'Dragon Ball Super', 'Dragon Ball Z',
    'DreamWorks', 'Ducati', 'Dumbledore', 'Dunkin', 'E.T.', 'Electronic Arts', 'eBay', 'Elden Ring', 'Electronic Arts',
    'Elgato', 'Embraer', 'Epic Games', 'ESA', 'ESPN', 'ETH', 'Ethereum', 'Etsy', 'F1', 'Facebook',
    'Family Guy', 'Fanta', 'Fantastic Beasts', 'FBI', 'Fendi', 'Ferrari', 'FIFA', 'Fila', 'Fisher-Price', 'Fitbit',
    'Five Guys', 'Forbes', 'Formula 1', 'Fortnite', 'Fox News', 'Frodo', 'Fujifilm', 'Fullmetal Alchemist',
    'Funimation', 'Funko', 'Futurama', 'G.I. Joe', 'Game of Thrones', 'Gandalf', 'Garfield', 'Garmin', 'Gatorade',
    'GeForce', 'Genshin Impact', 'Ghostbusters', 'Givenchy', 'Gmail', 'GMC', 'Goku', 'Google', 'GoPro', 'Grand Theft Auto',
    'Grogu', 'Gryffindor', 'GTA', 'Gucci', 'Guinness', 'Gymshark', 'H&M', 'Harley-Davidson', 'Harry Potter', 'Hasbro',
    'HBO', 'Heineken', 'Hello Kitty', 'Hermès', 'Hogwarts', 'Hoka', 'Home Depot', 'Honda', 'Honkai Star Rail', 'Hot Wheels',
    'House of the Dragon', 'House Stark', 'How to Train Your Dragon', 'HP', 'Huawei', 'Hufflepuff', 'Hulu', 'Hummer',
    'Hunter x Hunter', 'Hyrule', 'Hyundai', 'IBM', 'IKEA', 'Illumination', 'In-N-Out', 'Indiana Jones', 'IndyCar',
    'Infiniti', 'Intel', 'Jack Daniel\'s', 'James Bond', 'Jaws', 'JAXA', 'JBL',
    'Jedi', 'Jeep', 'John Wick', 'Johnnie Walker', 'Jordan', 'Jujutsu Kaisen', 'Jurassic Park', 'Jurassic World', 'Kawasaki',
    'KFC', 'Kia', 'KidKraft', 'Kimetsu no Yaiba', 'Kingston', 'Kirby', 'Konami', 'Korra', 'Kraken', 'Krispy Kreme',
    'Krusty Krab', 'Kung Fu Panda', 'LaLiga', 'Lamborghini', 'Land Rover', 'Lannister', 'League of Legends', 'Lego', 'LEGO',
    'Legolas', 'Lenovo', 'Levi\'s', 'Lexus', 'Lightsaber', 'Ligue 1', 'Lincoln', 'LinkedIn', 'Lionsgate', 'Logitech',
    'Longines', 'Lord of the Rings', 'Louis Vuitton', 'Lowe\'s', 'LPGA', 'Lucasfilm', 'Lucid', 'Luigi', 'Lululemon', 'LV',
    'Marvel', 'Maserati', 'Mastercard', 'Mattel', 'Mazda', 'McDonald\'s', 'McLaren',
    'Melissa & Doug', 'Mercedes-Benz', 'Meta', 'Metroid', 'MGM', 'Microsoft', 'Middle-earth', 'Miller',
    'Minecraft', 'Mini Cooper', 'Minions', 'Mission: Impossible', 'Mitsubishi', 'MLB', 'MLS', 'Modern Warfare',
    'Mojang', 'Moncler', 'Monster Energy', 'Monster Hunter', 'Montblanc', 'Mortal Kombat', 'MotoGP', 'Mountain Dew', 'MSI',
    'MTV', 'My Hero Academia', 'My Little Pony', 'Naruto', 'NASA', 'NASCAR', 'National Aeronautics and Space Administration',
    'National Park Service', 'NBA', 'NBC', 'NCAA', 'Neon Genesis Evangelion', 'Nerf', 'Nespresso', 'Netflix', 'New Balance',
    'New York Times', 'NFL', 'NHL', 'Nickelodeon', 'Nike', 'Nikon', 'Nintendo', 'Nissan', 'NOAA', 'Nokia', 'NPS',
    'NVIDIA', 'NWSL', 'Nvidia', 'Oculus', 'Off-White', 'Olympics', 'One Piece', 'OnePlus', 'Oppo',
    'Overwatch', 'Panasonic', 'Panera', 'Patek Philippe', 'Patrick Star', 'Patron', 'PayPal',
    'Peacock', 'Pepsi', 'PGA', 'Philips', 'Pikachu', 'Pirates of the Caribbean', 'Pixar', 'Pizza Hut', 'Plankton',
    'Play-Doh', 'PlayStation', 'Pokeball', 'Pokemon', 'Poké Ball', 'Pokémon', 'Polestar', 'Popeyes', 'Porsche', 'Power Rangers',
    'Powerade', 'Prada', 'Premier League', 'Prime Video', 'Princess Peach', 'PUBG', 'Qualcomm',
    'Radeon', 'Ralph Lauren', 'Rambo', 'Range Rover', 'Ravenclaw', 'Razer', 'Realme', 'Red Bull', 'Red Cross',
    'Red Dead Redemption', 'Reebok', 'Resident Evil', 'Reuters', 'Rick and Morty', 'Riot Games', 'Rivian', 'Robinhood', 'Roblox',
    'Rockstar Games', 'Rolex', 'Rolls-Royce', 'Roscosmos', 'RTX', 'Rubik\'s Cube', 'Saab', 'Sailor Moon', 'Saint Laurent',
    'Samsung', 'SanDisk', 'Sanrio', 'Sasuke', 'Sauron', 'Seagate', 'Searchlight', 'Sega', 'Sennheiser', 'Serie A',
    'Shake Shack', 'Shein', 'Shonen Jump', 'Shopify', 'Showtime', 'Shrek', 'Simpsons', 'Sith', 'Skechers', 'Skoda',
    'Slytherin', 'Smirnoff', 'Snapdragon', 'Solana', 'Sonic the Hedgehog', 'Sonos', 'Sony', 'Sony Pictures', 'South Park',
    'SpaceX', 'Splatoon', 'Spock', 'SpongeBob', 'SpongeBob SquarePants', 'Spotify', 'Sprite', 'Square Enix',
    'Squidward', 'Star Trek', 'Star Wars', 'Starbucks', 'StarCraft', 'Steam Deck', 'Steven Universe', 'Stormtrooper',
    'Stranger Things', 'Street Fighter', 'Stripe', 'Studio Ghibli', 'Studio Pierrot', 'Stussy', 'Subaru', 'Super Mario',
    'Superman', 'Suzuki', 'Taco Bell', 'TAG Heuer', 'Take-Two', 'Targaryen', 'Team USA', 'Teenage Mutant Ninja Turtles',
    'Tekken', 'Temu', 'The Beatles', 'The Godfather', 'The Guardian', 'The Hobbit', 'The Legend of Zelda', 'The Mandalorian',
    'The Matrix', 'The North Face', 'The Simpsons', 'The Upside Down', 'The Wall Street Journal', 'The Witcher', 'Tiffany & Co.',
    'Tim Hortons', 'TMNT', 'Toei Animation', 'Tokyo Ghoul', 'Tommy Hilfiger', 'Toyota', 'TriStar',
    'Twitter', 'Ubisoft', 'UEFA', 'UFC', 'Ugg', 'Under Armour', 'UNICEF', 'Uniqlo', 'United Nations', 'United States Postal Service',
    'Universal Studios', 'USPS', 'Valorant', 'Valyrian', 'Vegeta', 'Venmo', 'Versace', 'Vespa', 'Viacom',
    'Victoria\'s Secret', 'Voldemort', 'Volkswagen', 'Volvo', 'VW', 'Walmart', 'Warcraft', 'Warner Bros', 'Warner Bros.',
    'Warzone', 'Wayfair', 'Wendy\'s', 'Western Digital', 'WhatsApp', 'WHO', 'Whole Foods', 'Winter is Coming',
    'World Health Organization', 'World of Warcraft', 'WSJ', 'WWE', 'X Games', 'Xbox', 'Xiaomi', 'Yahoo', 'Yamaha', 'Yeezy', 'Yoshi',
    'YouTube', 'YSL', 'Zalando', 'Zara', 'Zelda', 'KPop Demon Hunters', 'HUNTR/X', 'Grinch', 'Huntrix', 'Demon Hunters'
];
